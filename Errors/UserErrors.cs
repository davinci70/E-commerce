...
public static class UserErrors
{
    ...
    public static readonly Error UserNotAuthenticated =
        new("User.UserNotAuthenticated", "No authenticated user", StatusCodes.Status403Forbidden);
    ...
    public static readonly Error DublicatedPhoneNumber =
        new("User.DublicatedPhoneNumber", "this phone number is already used by another user", StatusCodes.Status409Conflict);

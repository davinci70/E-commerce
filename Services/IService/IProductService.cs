...
public interface IProductService
{
    ...
    Task<Result<PaginatedList<ProductsInCategoryResponse>>> GetByProductTypeIdAsync(int Id, RequestFilters filters, CancellationToken cancellationToken = default);
